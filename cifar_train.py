...
def main_worker(gpu, ngpus_per_node, args):
    ...
    num_of_channels = 1 if args.dataset == 'mnist' else 3
    model = models.__dict__[args.arch](num_classes=num_classes, use_norm=use_norm,num_of_channels=num_of_channels)
